...
#Plot1
plot(SerialTime, G_A_power, xlab = "Datetime" , ylab = "Global Active Power (KW)", type = "l")
#Plot2
plot(SerialTime, y = Voltage, type = "l", xlab = "Datetime", ylab = "Voltage")
#Plot3
...
x <- my_data_long[,1]
y <- my_data_long[,3]
plot(x,y,type="n",ylab="Energy sub metering", xlab="Datetime")
...
#Plot4
plot(SerialTime, y = G_R_power, type = "l", xlab = "Datetime", ylab = "Global Reactive Power")
dev.copy(png, file = "plot4.png") ## Copy my plot to PNG file
dev.off() 
